...
interface ReferralLetterModalProps {
    ...
    data: {
        ...
        submission: {
            ...
            replySlip: string;
            curriculum: string;
            needsResubmitReplySlip?: boolean;
            needsResubmitCurriculum?: boolean;
        };
    };
}

export function ReferralLetterModal({ isOpen, onClose, data }: ReferralLetterModalProps) {
                ...
                <ModalBody className="max-h-[70vh] overflow-y-auto p-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <section className="space-y-3 border-r px-4">
                            ...
                            {/* Submission details moved here if needed */}
                            <div className="mt-4">
                                <h2 className="text-lg font-semibold text-dost-title border-b pb-2">
                                    Submission Details
                                </h2>
                        ...
                        <section className="space-y-4 pl-4">
                            ...
                            <DocumentItem
                                label="Reply Slip:"
                                fileName={submission.replySlip}
                                needsResubmit={submission.needsResubmitReplySlip}
                            />

                            <DocumentItem
                                label="Course Curriculum:"
                                fileName={submission.curriculum}
                                needsResubmit={submission.needsResubmitCurriculum}
                            />
