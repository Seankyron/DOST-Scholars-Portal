...
// 1. Export the interface so the parent (page.tsx) can use it
export interface PTPFiltersState {
  status: string;
  trainingYear: string;
  semester: string;
  academicYear: string;
...
interface PTPFiltersProps {
  ...
  filters: PTPFiltersState;
  onFilterChange: (key: keyof PTPFiltersState, value: any) => void;
  onReset: () => void;
}
    ...
    <div className="flex flex-col gap-4 bg-white p-1">
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
        ...
        <Select 
          ...
          onValueChange={(val) => onFilterChange('trainingYear', val)}
        >
          <SelectTrigger className="bg-white h-10 w-full">
        ...
        >
          ...
          <SelectContent>
            ...
            <SelectItem value="AY 2022-2023">AY 2022-2023</SelectItem>
          </SelectContent>
        </Select>
