...
function TabsTrigger({
  ...
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        // We remove all default color and shadow classes from here.
        // REMOVED: data-[state=active]:bg-background
        // REMOVED: dark:data-[state=active]:text-foreground
        // REMOVED: dark:data-[state=active]:border-input
        // REMOVED: dark:data-[state=active]:bg-input/30
        // REMOVED: text-foreground
        // REMOVED: dark:text-muted-foreground
        // REMOVED: data-[state=active]:shadow-sm
        
        // This is the cleaned-up base class string:
