...
interface FormProps {
  ...
  guaranteeLetter: File | null; setGuaranteeLetter: (f: File | null) => void;
...
export function OfficialBusinessForm({
  ...
  const showGuarantee = checkVisibility(['guarantee', 'employer']);
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        ...
        {showGuarantee.isEditable ? (
            <FileUpload
                label="Guarantee Letter from Employer"
                helperText="Addressed to Dr. Jayeel S. Cornelio (DOST-SEI Director)"
                onChange={setGuaranteeLetter}
                required
            />
        ) : (
            <FileDisplayReadOnly label="Guarantee Letter" fileName="Submitted File" />
        )}
