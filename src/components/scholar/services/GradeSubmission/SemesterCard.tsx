...
const statusConfig: Record<string, { icon: React.ElementType, text: string, cta: string, iconColor: string }> = {
  ...
  Approved: { icon: Check, text: 'Approved', cta: 'View Submission', iconColor: 'text-green-600' },
  ...
  Closed: { icon: Check, text: 'Closed', cta: 'View Submission', iconColor: 'text-green-600' },
};
